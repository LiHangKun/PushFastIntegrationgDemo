...
public class MyApplication extends Application {
    ...
    public void onCreate() {
        ...
        UMConfigure.init(this, "5feb1d12d2ef17042d36da58", "Umeng", UMConfigure.DEVICE_TYPE_PHONE, "67c9e339ba39069e38a8d70310be83c9");
...
//        mPushAgent.setNotificationPlaySound(MsgConstant.NOTIFICATION_PLAY_SERVER); //服务端控制声音
       ...
       /* UmengMessageHandler messageHandler = new UmengMessageHandler() {
            ...
            public Notification getNotification(Context context, UMessage uMessage) {
                Log.i("aaa","收到的消息"+uMessage.ticker+uMessage.title+uMessage.extra.get("neirong"));
